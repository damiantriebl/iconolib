function Icon_3d_rect_from_center ({size='16', strokeWidth='1.5', stroke='currentColor', fill='none'}:{size:'16' | '24' | '32', strokeWidth:string, stroke:string, fill:string}) {
...
export { Icon_3d_rect_from_center };
